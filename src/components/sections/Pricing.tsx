    ...
    <Section id="programa" tone="canvas">
      <div className="max-w-2xl">
        ...
        <h2 className="mt-4 text-[clamp(1.9rem,1rem+2.6vw,3rem)] leading-[1.08] tracking-[-0.02em] font-[350]">
          Todo lo que incluye tu copia.
        </h2>
      </div>

      <div className="mt-12 grid gap-6 lg:grid-cols-2 lg:items-start">
        <Reveal>
          <div className="rounded-[54px] bg-[#fdfdfd] hairline p-10">
        ...
        <Reveal delay={0.1}>
          <div className="rounded-[54px] bg-[#fdfdfd] hairline p-10 lg:h-full lg:flex lg:flex-col lg:justify-center">
